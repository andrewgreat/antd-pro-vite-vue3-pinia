export default {
  ...
  'account.settings.basic.address-message': '請輸入您的街道位址!',
  'account.settings.basic.phone': '聯繫電話',
  'account.settings.basic.phone-message': '請輸入您的聯繫電話!',
  'account.settings.basic.update': '更新基本資訊',
  ...
  'account.settings.security.password': '帳戶密碼',
  ...
  'account.settings.security.question-description': '未設置密保問題，密保問題可有效保護帳戶安全',
  ...
  'account.settings.binding.taobao-description': '當前未綁定淘寶帳號',
  'account.settings.binding.alipay': '綁定支付寶',
  'account.settings.binding.alipay-description': '當前未綁定支付寶帳號',
  'account.settings.binding.dingding': '綁定釘釘',
  'account.settings.binding.dingding-description': '當前未綁定釘釘帳號',
  'account.settings.binding.bind': '綁定',
  'account.settings.notification.password': '帳戶密碼',
  'account.settings.notification.password-description': '其他使用者的消息將以站內信的形式通知',

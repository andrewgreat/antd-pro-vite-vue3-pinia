      ...
      <a-col :sm="24" :md="12" :xl="6" :style="{ marginBottom: '24px' }">
        ...
        >
          ...
          <template #footer
            ...
            }}<span> {{ NumberFormat("1234") }}</span></template
          >
        </chart-card>
      </a-col>
      <a-col :sm="24" :md="12" :xl="6" :style="{ marginBottom: '24px' }">
    ...
    <a-card :loading="loading" :bordered="false" :body-style="{ padding: '0' }">
      <div class="salesCard">
        ...
        >
          ...
          <a-tab-pane
            loading="true"
            :tab="$t('dashboard.analysis.sales')"
            key="1"
          >
            <a-row>
              <a-col :xl="16" :lg="12" :md="12" :sm="24" :xs="24">
                <bar
                  domId="chartBar1"
                  :data="barData"
                  :title="$t('dashboard.analysis.sales-trend')"
                >
                  <template #barArea>
              ...
              <a-col :xl="8" :lg="12" :md="12" :sm="24" :xs="24">
                <rank-list
                  :title="$t('dashboard.analysis.sales-ranking')"
                  :list="rankList"
                />
              </a-col>
            </a-row>
          ...
          <a-tab-pane :tab="$t('dashboard.analysis.visits')" key="2">
            <a-row>
              ...
              <a-col :xl="8" :lg="12" :md="12" :sm="24" :xs="24">
                <rank-list
                  :title="$t('dashboard.analysis.visits-ranking')"
                  :list="rankList"
                />
              </a-col>
            </a-row>
            ...
            <a-row :gutter="68">
              <a-col :xs="24" :sm="12" :style="{ marginBottom: ' 24px' }">
                ...
                <div>
                  <mini-smooth-area
                    :style="{ height: '45px' }"
                    domId="chartMiniSmoothArea1"
                    :dataSource="searchUserData"
                  >
                    <template #chart>
                      <div
                        id="chartMiniSmoothArea1"
                        :style="{ height: '8vh' }"
                      ></div>
                    </template>
                  </mini-smooth-area>
              ...
              <a-col :xs="24" :sm="12" :style="{ marginBottom: ' 24px' }">
                ...
                <div>
                  <mini-smooth-area
                    :style="{ height: '45px' }"
                    domId="chartMiniSmoothArea2"
                    :dataSource="searchUserData2"
                  >
                    <template #chart>
                      <div
                        id="chartMiniSmoothArea2"
                        class="chart-wrapper"
                        :style="{ height: '8vh' }"
                      ></div>
                    </template>
            ...
            <div>
              ...
              <div>
                <pie
                  domId="chartPie"
                  :data="pieData"
                  :title="$t('dashboard.analysis.sales')"
                >
                  <template #pieArea>
...
export default defineComponent({
  ...
  setup() {
    ...
    const searchTableColumns = computed<TableColumnType[]>(() => {
      return [
        {
          dataIndex: "index",
